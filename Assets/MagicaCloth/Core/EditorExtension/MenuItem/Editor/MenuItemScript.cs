...
namespace MagicaCloth
{
    ...
    public class MenuItemScript
    {
        ...
        {
            var obj = AddObject("Magica Virtual Deformer", false);
        ...
        {
            var obj = AddObject("Magica Bone Cloth", false);
        ...
        {
            var obj = AddObject("Magica Bone Spring", false);
        ...
        {
            var obj = AddObject("Magica Mesh Cloth", false);
        ...
        {
            var obj = AddObject("Magica Mesh Spring", false);
        ...
        {
            var obj = AddObject("Magica Sphere Collider", true);
        ...
        {
            var obj = AddObject("Magica Capsule Collider", true);
        ...
        {
            var obj = AddObject("Magica Plane Collider", true);
        ...
        /// <returns></returns>
        static GameObject AddObject(string objName, bool addParentName)
        {

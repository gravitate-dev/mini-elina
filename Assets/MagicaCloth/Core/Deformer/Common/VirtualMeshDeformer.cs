...
namespace MagicaCloth
{
    ...
    public class VirtualMeshDeformer : BaseMeshDeformer
    {
        ...
        public override bool AddUseVertex(int vindex)
        {
            ...
            bool change = MagicaPhysicsManager.Instance.Mesh.AddUseVirtualVertex(MeshIndex, vindex);
        ...
        public override bool RemoveUseVertex(int vindex)
        {
            ...
            bool change = MagicaPhysicsManager.Instance.Mesh.RemoveUseVirtualVertex(MeshIndex, vindex);

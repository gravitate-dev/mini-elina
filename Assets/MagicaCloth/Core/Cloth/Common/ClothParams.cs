...
namespace MagicaCloth
{
    ...
    public class ClothParams
    {
        ...
        // テレポート
        [SerializeField]
        private bool useResetTeleport = true;
        [SerializeField]
        ...
        [SerializeField]
        private float clampDistanceMinRatio = 0.9f;
        [SerializeField]
        private float clampDistanceMaxRatio = 1.1f;
        [SerializeField]
        private float clampDistanceVelocityInfluence = 0.5f;
        ...
        [SerializeField]
        private float clampPositionVelocityInfluence = 0.5f;
        ...
        [SerializeField]
        private float clampRotationVelocityInfluence = 0.3f;
        ...
        [SerializeField]
        private BezierParam nearDistanceLength = new BezierParam(0.05f, 0.05f, true, 0.0f, false);
        [SerializeField]
        ...
        // clamp position
        public void SetClampPositionLength(bool sw, float sval = 0.03f, float eval = 0.2f, float ratioX = 1, float ratioY = 1, float ratioZ = 1, float influence = 0.5f)
        {
        ...
        // clamp rotation
        public void SetClampRotationAngle(bool sw, float sval = 30.0f, float eval = 30.0f, float influence = 0.3f)
        {
            useClampRotation = sw;

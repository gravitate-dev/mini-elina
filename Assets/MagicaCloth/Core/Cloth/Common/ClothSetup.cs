...
namespace MagicaCloth
{
    ...
    public class ClothSetup
    {
        ...
        public void ClothInit(
            ...
            //System.Func<int, Transform> funcUserTransform = null,
            //System.Func<int, float3> funcUseTransformLocalPosition = null,
            //System.Func<int, quaternion> funcUseTransformLocalRotation = null
            )
        {
            ...
            var c = team.CreateParticle(team.TeamId, clothData.useVertexList.Count,
                ...
                //(i) =>
                //{
                //    if (funcUseTransformLocalPosition != null)
                //        return funcUseTransformLocalPosition(i);
                //    else
                //        return 0;
                //},
                // lrot
                //(i) =>
                //{
                //    if (funcUseTransformLocalRotation != null)
                //        return funcUseTransformLocalRotation(i);
                //    else
                ...
                //{
                //    Transform t = null;
                //    if (funcUserTransform != null)
                //    {
                //        t = funcUserTransform(i); // ユーザートランスフォーム
                //    }
                //    return t;
                //}
                // target local pos
            ...
            if (param.UseClampDistanceRatio && clothData.ClampDistanceConstraintCount > 0)
            {
                ...
                //sw.Stop();
                //Debug.Log("ClampDistance.AddGroup():" + sw.ElapsedMilliseconds);
            }
            ...
            if (clothData.StructDistanceConstraintCount > 0 || clothData.BendDistanceConstraintCount > 0 || clothData.NearDistanceConstraintCount > 0)
            {
                ...
                //sw.Stop();
                //Debug.Log("RestoreDistance.AddGroup():" + sw.ElapsedMilliseconds);
            }
            ...
            if (param.UseRestoreRotation && clothData.RestoreRotationConstraintCount > 0)
            {
                ...
                //sw.Stop();
                //Debug.Log("RestoreRotation.AddGroup():" + sw.ElapsedMilliseconds);
            }
            ...
            if (param.UseClampRotation && clothData.ClampRotationConstraintDataCount > 0)
            {
                ...
                //sw.Stop();
                //Debug.Log("ClampRotation.AddGroup():" + sw.ElapsedMilliseconds);
            }
            ...
            if (param.UseTriangleBend && clothData.TriangleBendConstraintCount > 0)
            {
                ...
                //sw.Stop();
                //Debug.Log("TriangleBend.AddGroup():" + sw.ElapsedMilliseconds);
            }
            ...
            if (param.UseAdjustRotation && param.AdjustRotationMode != ClothParams.AdjustMode.None)
            {
                ...
                //sw.Stop();
                //Debug.Log("AdjustRotation.AddGroup():" + sw.ElapsedMilliseconds);
            }
        ...
        public void ChangeData(PhysicsTeam team, ClothParams param)
        {
            ...
            // ライン回転補間
            if (param.ChangedParam(ClothParams.ParamType.AdjustLine))
            {

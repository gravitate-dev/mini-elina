...
namespace MagicaCloth
{
    ...
    public abstract class ClothEditor : Editor
    {
        ...
        protected void DrawInspectorGUI(IEditorMesh editorMesh)
        {
            ...
            pointSelector.DrawInspectorGUI(StartEdit, EndEdit);
        }
        ...
        protected void UserBlendInspector()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.Slider(serializedObject.FindProperty("teamData.userBlendRatio"), 0.0f, 1.0f, "Blend Weight");
        }
    }
}